...
abstract class AbstractRevision implements RevisionInterface
{
    ...
    /**
     * @phpstan-return self::ACTION_CREATE|self::ACTION_UPDATE|self::ACTION_REMOVE
     */
    ...
    /**
     * @phpstan-param non-empty-string $revisionableId
     */
    ...
    /**
     * @phpstan-param non-empty-string|null $username
     */
