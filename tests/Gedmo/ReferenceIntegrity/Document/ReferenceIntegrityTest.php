...
namespace Gedmo\ReferenceIntegrity\Document;
...
{
    const TYPE_ONE_NULLIFY_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\OneNullify\Type';
    const ARTICLE_ONE_NULLIFY_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\OneNullify\Article';

    const TYPE_MANY_NULLIFY_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\ManyNullify\Type';
    const ARTICLE_MANY_NULLIFY_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\ManyNullify\Article';

    const TYPE_ONE_RESTRICT_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\OneRestrict\Type';
    const ARTICLE_ONE_RESTRICT_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\OneRestrict\Article';

    const TYPE_MANY_RESTRICT_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\ManyRestrict\Type';
    const ARTICLE_MANY_RESTRICT_CLASS = 'Gedmo\Fixture\ReferenceIntegrity\Document\ManyRestrict\Article';
