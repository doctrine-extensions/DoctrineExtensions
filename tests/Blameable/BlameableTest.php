...
use Fixture\Blameable\Article;
use Fixture\Blameable\Comment;
use Fixture\Blameable\Type;
use Gedmo\Blameable\BlameableListener;

class BlameableTest extends ObjectManagerTestCase
{
    const ARTICLE = "Fixture\Blameable\Article";
    const COMMENT = "Fixture\Blameable\Comment";
    const TYPE = "Fixture\Blameable\Type";
     ...
     * @test
     */
    public function shouldHandleGeneralBlameableFunctionality()
    {
        $sport = new Article();
     ...
     * @test
     */
    public function shouldHandleManualValues()
    {
        $sport = new Article();
