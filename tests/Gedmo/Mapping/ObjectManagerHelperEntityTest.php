...
class ObjectManagerHelperEntityTest extends ObjectManagerTestCase
{
     ...
     * @test
     */
    public function shouldExtractIdentifierFromManagedEntity()
    {
     ...
     * @test
     */
    public function shouldManageProxy()
    {
        $this->em->clear();
     ...
     * @test
     */
    public function shouldHandleDetachedEntity()
    {
     ...
     * @test
     */
    public function shouldAlsoHandleDetachedProxy()
    {
        $this->em->clear();
        $test = $this->em->getReference(self::ADDRESS, array('id' => 1));
        $this->em->clear();
