 ...
 * file that was distributed with Symfony 2 source code.
 */

namespace Tool\Logging\ODM;
 ...
 * @author Michael Williams <michael.williams@funsational.com> Simplified some code for basic usage
 */
class QueryAnalyzer
{
    protected $queries;
