...
namespace Blameable\Document;

use TestTool\ObjectManagerTestCase;
use Doctrine\Common\EventManager;
use Fixture\Blameable\Document\Article;
use Fixture\Blameable\Document\Type;
use Fixture\Blameable\Document\User;
...
class BlameableTest extends ObjectManagerTestCase
{
    ...
    const TYPE = 'Fixture\Blameable\Document\Type';
    const USER = 'Fixture\Blameable\Document\User';
    const ARTICLE = 'Fixture\Blameable\Document\Article';
     ...
     * @test
     */
    public function shouldHandleBlameableDocument()
    {
        $sport = new Article();
