...
namespace Sortable\Document;

use TestTool\ObjectManagerTestCase;
use Doctrine\Common\EventManager;
use Gedmo\Sortable\SortableListener;
use Fixture\Sortable\Document\Article;
use Fixture\Sortable\Document\Type;

class SortableTest extends ObjectManagerTestCase
{
    const ARTICLE = 'Fixture\Sortable\Document\Article';
    const TYPE = 'Fixture\Sortable\Document\Type';
     ...
     * @test
     */
    public function shouldHandleSortableDocument()
    {
     ...
     * @test
     */
    public function shouldHandleNullGroup()
    {
        $php = new Article();
        $php->setTitle('php');
