...
class ClosureTreeTest extends ObjectManagerTestCase
{
    ...
    const PERSON = 'Fixture\Tree\Closure\Person';
    const USER = 'Fixture\Tree\Closure\User';
    const PERSON_CLOSURE = 'Fixture\Tree\Closure\PersonClosure';
    const NEWS = 'Fixture\Tree\Closure\News';
     ...
     * @test
     */
    public function shouldManageBasicClosureTree()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
     ...
     * @test
     */
    public function shouldHandleUpdateOfParent()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
     ...
     * @test
     */
    public function shouldHandleAnotherUpdateOfParent()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
        $strawberries = $repo->findOneByTitle('Strawberries');
     ...
     * @test
     */
    public function shouldBeAbleToRemoveBranch()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
     ...
     */
    public function shouldNotAllowToSetParentAsChild()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
        $fruits = $repo->findOneByTitle('Fruits');
        $strawberries = $repo->findOneByTitle('Strawberries');
     ...
     * @test
     */
    public function shouldCheckIfEntityHasNotIncludedTreeLevelFieldThenDontProcessIt()
    {
     ...
     * @test
     */
    public function shouldHandleCascadePersist()
    {
