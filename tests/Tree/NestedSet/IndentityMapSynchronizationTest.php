...
use Fixture\Tree\NestedSet\Genealogy\Man;
use Fixture\Tree\NestedSet\Genealogy\Woman;

class IndentityMapSynchronizationTest extends ObjectManagerTestCase
{
    const CATEGORY = "Fixture\Tree\NestedSet\Category";
    const PERSON = "Fixture\Tree\NestedSet\Genealogy\Person";
    const MAN = "Fixture\Tree\NestedSet\Genealogy\Man";
    const WOMAN = "Fixture\Tree\NestedSet\Genealogy\Woman";
     ...
     * @test
     */
    public function shouldSynchronizeInsertedNodesInIdentityMap()
    {
     ...
     * @test
     */
    public function shouldSynchronizeIdentityMapWithInheritance()
    {
        $nodes = array();
