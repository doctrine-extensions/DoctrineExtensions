...
> [!WARNING]
> The `SlugHandlerOption` attribute is deprecated and will be removed in 4.0. Using this attribute is not supported, and instead, the options should be configured directly in the `SlugHandler` attribute's **options** parameter.
