...
- Sometime slugable generate ugly slugs (when used with length limit) like some-slug--2, new option removeDoubleSeparator provide ability to remove double slugs. Disabled by default for BC.
...
- **removeDoubleSeparator** (optional, default=false) - **true** double separators like some-slug--2 would be changed to some-slug-2
