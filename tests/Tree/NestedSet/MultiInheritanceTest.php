...
use Fixture\Tree\NestedSet\Node\Node;
use Fixture\Tree\NestedSet\Node\ANode;
use Fixture\Tree\NestedSet\Node\BaseNode;
use Gedmo\Timestampable\TimestampableListener;
use Gedmo\Sluggable\SluggableListener;

class MultiInheritanceTest extends ObjectManagerTestCase
{
    const NODE = "Fixture\Tree\NestedSet\Node\Node";
    const BASE_NODE = "Fixture\Tree\NestedSet\Node\BaseNode";
    const ANODE = "Fixture\Tree\NestedSet\Node\ANode";
