...
use Gedmo\Fixture\Translatable\Transport\Vehicle;
use Gedmo\Fixture\Translatable\Transport\VehicleTranslation;
use Gedmo\Fixture\Translatable\Transport\Car;
use Gedmo\Fixture\Translatable\Transport\Engine;
use Gedmo\Fixture\Translatable\Transport\Motorcycle;
...
class InheritanceTest extends ObjectManagerTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->createSchema($this->em, array(
            'Gedmo\Fixture\Translatable\Transport\Vehicle',
            'Gedmo\Fixture\Translatable\Transport\VehicleTranslation',
            'Gedmo\Fixture\Translatable\Transport\Car',
            'Gedmo\Fixture\Translatable\Transport\Engine',
            'Gedmo\Fixture\Translatable\Transport\Motorcycle',
        ));
    }
    ...
    function shouldHandleInheritance()
    {
        ...
        $translations = $this->em->getRepository('Gedmo\Fixture\Translatable\Transport\VehicleTranslation')->findAll();
        ...
        $hayabusa = $this->em->getRepository('Gedmo\Fixture\Translatable\Transport\Vehicle')->findOneBySpeed(290);
        $this->assertSame('Hayabusa de', $hayabusa->getTitle(), 'should be translated in de');

        $audi80 = $this->em->getRepository('Gedmo\Fixture\Translatable\Transport\Vehicle')->findOneBySpeed(200);
