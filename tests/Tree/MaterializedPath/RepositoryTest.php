...
class RepositoryTest extends ObjectManagerTestCase
{
    ...
    const CATEGORY = 'Fixture\Tree\MaterializedPath\MPCategory';
     ...
     * @test
     */
    public function shouldGenerateChildrenHierarchy()
    {
     ...
     * @test
     */
    public function shouldCountChildren()
    {
        // Count all
     ...
     * @test
     */
    public function shouldFixIssue458()
    {
        $this->em->clear();
