...
use Gedmo\Fixture\Sortable\Node;
use Gedmo\Fixture\Sortable\Item;
use Gedmo\Fixture\Sortable\Category;
use Gedmo\Fixture\Sortable\SimpleListItem;
use Gedmo\Fixture\Sortable\Author;
use Gedmo\Fixture\Sortable\Paper;
use Gedmo\Fixture\Sortable\Event;
use Gedmo\Sortable\SortableListener;

class SortableTest extends ObjectManagerTestCase
{
    const NODE = 'Gedmo\Fixture\Sortable\Node';
    const ITEM = 'Gedmo\Fixture\Sortable\Item';
    const CATEGORY = 'Gedmo\Fixture\Sortable\Category';
    const SIMPLE_LIST_ITEM = 'Gedmo\Fixture\Sortable\SimpleListItem';
    const AUTHOR = 'Gedmo\Fixture\Sortable\Author';
    const PAPER = 'Gedmo\Fixture\Sortable\Paper';
    const EVENT = 'Gedmo\Fixture\Sortable\Event';
