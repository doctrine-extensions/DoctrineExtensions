...
class ClosureTreeRepositoryTest extends ObjectManagerTestCase
{
     ...
     * @test
     */
    public function shouldBeAbleToCountChildren()
    {
        $this->populate();
     ...
     * @test
     */
    public function shouldBeAbleToGetNodePath()
    {
        $this->populate();
     ...
     * @test
     */
    public function shouldBeAbleToRemoveSingleNodeFromTree()
    {
        $this->populate();
     ...
     * @test
     */
    public function shouldBuildTreeWithLevelProperty()
    {
     ...
     * @test
     */
    public function shouldBuildTreeWithoutLevelProperty()
    {
        if ($this->em->getConnection()->getDatabasePlatform()->getName() === 'postgresql') {
            $this->markTestSkipped('Postgresql database requires GROUP BY statement or different query.');
        }
     ...
     * @test
     */
    public function shouldAvoidSubqueryInSelectHavingLevelPropertyInGetNodesHierarchy()
    {
        $this->populate();
     ...
     * @test
     */
    public function shouldUseASubqueryInSelectNotHavingLevelPropertyInGetNodesHierarchy()
    {
        $this->populate(self::CATEGORY_WITHOUT_LEVEL);
     ...
     * @test
     */
    public function shouldChangeChildrenIndex()
    {
        if ($this->em->getConnection()->getDatabasePlatform()->getName() === 'postgresql') {
            $this->markTestSkipped('Postgresql database requires GROUP BY statement or different query.');
        }
