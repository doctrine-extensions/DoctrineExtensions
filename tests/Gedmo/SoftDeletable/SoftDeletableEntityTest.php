...
use Doctrine\Common\Util\Debug,
    SoftDeletable\Fixture\Entity\Article,
    SoftDeletable\Fixture\Entity\Comment,
    SoftDeletable\Fixture\Entity\User,
    SoftDeletable\Fixture\Entity\Page,
    SoftDeletable\Fixture\Entity\MegaPage,
    SoftDeletable\Fixture\Entity\Module,
    SoftDeletable\Fixture\Entity\OtherArticle,
    SoftDeletable\Fixture\Entity\OtherComment,
    SoftDeletable\Fixture\Entity\Child,
 ...
 */
class SoftDeletableEntityTest extends BaseTestCaseORM
{
    const ARTICLE_CLASS = 'SoftDeletable\Fixture\Entity\Article';
    const COMMENT_CLASS = 'SoftDeletable\Fixture\Entity\Comment';
    const PAGE_CLASS = 'SoftDeletable\Fixture\Entity\Page';
    const MEGA_PAGE_CLASS = 'SoftDeletable\Fixture\Entity\MegaPage';
    const MODULE_CLASS = 'SoftDeletable\Fixture\Entity\Module';
    const OTHER_ARTICLE_CLASS = 'SoftDeletable\Fixture\Entity\OtherArticle';
    const OTHER_COMMENT_CLASS = 'SoftDeletable\Fixture\Entity\OtherComment';
    const USER_CLASS = 'SoftDeletable\Fixture\Entity\User';
    const MAPPED_SUPERCLASS_CHILD_CLASS = 'SoftDeletable\Fixture\Entity\Child';
    ...
    public function shouldSoftlyDeleteIfColumnNameDifferFromPropertyName()
    {
        ...
        $this->em->getFilters()->disable(self::SOFT_DELETABLE_FILTER_NAME);
        $user = $repo->findOneBy(array('username' => $username));
    ...
    public function testSoftDeletable()
    {
        ...
        $query->setHint(
            ...
            'Gedmo\SoftDeletable\Query\TreeWalker\SoftDeletableWalker'
        );
    ...
    {
        $filter = $this->em->getFilters()->enable(self::SOFT_DELETABLE_FILTER_NAME);
