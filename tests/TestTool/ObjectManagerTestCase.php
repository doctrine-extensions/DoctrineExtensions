...
abstract class ObjectManagerTestCase extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @param EventManager|null               $evm    - defaults to event manager hooked with all extensions
     * @param array|null                      $conn   - connection parameters, defaults to memory sqlite
     * @param EntityManagerConfiguration|null $config - ORM configuration, defaults to annotation driver based mock
     *
     * @return EntityManager
     */
    protected function createEntityManager(EventManager $evm = null, array $conn = null, EntityManagerConfiguration $config = null)
    {
     ...
     *
     * @param EventManager|null                        $evm    - defaults to event manager hooked with all extensions
     * @param Connection|null                          $conn   - mongodb connection
     * @param MongoDBDocumentManagerConfiguration|null $config - ODM mongodb configuration, defaults to annotation driver based mock
     *
