...
class HardRelationTest extends BaseTestCaseORM
{
    ...
    public function shouldCascadeSoftdeleteForHardRelations()
    {
        ...
        $person = $this->em->getRepository('Gedmo\Tests\SoftDeleteable\Fixture\Entity\Person')->findOneBy(['id' => $person->getId()]);
    ...
    public function shouldCascadeToInversedRelationAsWell()
    {
        ...
        $address = $this->em->getRepository('Gedmo\Tests\SoftDeleteable\Fixture\Entity\Address')->findOneBy(['id' => $address->getId()]);
    ...
    {
        return [
            'Gedmo\Tests\SoftDeleteable\Fixture\Entity\Person',
            'Gedmo\Tests\SoftDeleteable\Fixture\Entity\Address',
        ];
    }
}
