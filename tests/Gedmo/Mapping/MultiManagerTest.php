...
class MultiManagerTest extends ObjectManagerTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->createSchema($this->em2, array(
            'Gedmo\Fixture\Unmapped\Translatable',
            'Gedmo\Fixture\Unmapped\TranslatableTranslation',
        ));
     ...
     * @test
     */
    public function shouldHandleThreeObjectManagerInteraction()
    {
        $dmPost = new \Gedmo\Fixture\Translatable\Document\Post();
        ...
        $em1Post = new \Gedmo\Fixture\Translatable\Post();
        ...
        $em2Translatable = new \Gedmo\Fixture\Unmapped\Translatable();
        ...
        $this->assertCount(1, $this->em2->getRepository('Gedmo\Fixture\Unmapped\TranslatableTranslation')->findAll());
    }
}
