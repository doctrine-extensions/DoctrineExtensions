...
use Gedmo\Fixture\Uploadable\FileAppendNumberRelative;
...
class UploadableEntityTest extends ObjectManagerTestCase
{
    ...
    const FILE_APPEND_NUMBER_RELATIVE_PATH_CLASS = 'Gedmo\Fixture\Uploadable\FileAppendNumberRelative';
    ...
    protected function setUp()
    {
        ...
        $this->createSchema($this->em, array(
            ...
            self::FILE_APPEND_NUMBER_RELATIVE_PATH_CLASS,
