...
When the owning side is a ReferenceMany and ReferenceIntegrity is set to 'pull', the referenced would automatically
be pulled from the collection of referenced documents on the owning side.
