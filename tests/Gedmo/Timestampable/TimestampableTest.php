...
use Gedmo\Fixture\Timestampable\Article;
use Gedmo\Fixture\Timestampable\Comment;
use Gedmo\Fixture\Timestampable\Type;

class TimestampableTest extends ObjectManagerTestCase
{
    const ARTICLE = "Gedmo\Fixture\Timestampable\Article";
    const COMMENT = "Gedmo\Fixture\Timestampable\Comment";
    const TYPE = "Gedmo\Fixture\Timestampable\Type";
     ...
     * @test
     */
    public function shouldPlaceAndUpdateTimestamps()
    {
        $sport = new Article();
     ...
     * @test
     */
    public function shouldBeAbleToSetDatesManually()
    {
        $sport = new Article();
