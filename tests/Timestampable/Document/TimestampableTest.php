...
namespace Timestampable\Document;

use TestTool\ObjectManagerTestCase;
use Doctrine\Common\EventManager;
use Gedmo\Timestampable\TimestampableListener;
use Fixture\Timestampable\Document\Article;
use Fixture\Timestampable\Document\Type;

class TimestampableTest extends ObjectManagerTestCase
{
    const ARTICLE = 'Fixture\Timestampable\Document\Article';
    const TYPE = 'Fixture\Timestampable\Document\Type';
     ...
     * @test
     */
    public function shouldHandleBaseTimestampableFunctionality()
    {
        $stamps = new Article();
     ...
     * @test
     */
    public function shouldHandleManuallySetDates()
    {
        $sport = new Article();
