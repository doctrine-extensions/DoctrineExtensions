...
class RepositoryTest extends ObjectManagerTestCase
{
     ...
     * @test
     */
    public function shouldManageAdvancedFunctions()
    {
        $this->populateMore();
     ...
     * test
     */
    public function shouldRemoveASingleRootNode()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
        $meta = $this->em->getClassMetadata(self::CATEGORY);
        var_dump('add more');
     ...
     * @test
     */
    public function shouldVerifyAndRecover()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
        $meta = $this->em->getClassMetadata(self::CATEGORY);
        $this->populateMore();
     ...
     * @test
     */
    public function shouldMoveRootNode()
    {
        $repo = $this->em->getRepository(self::CATEGORY);
        $food = $repo->findOneByTitle('Food');
     ...
     * @test
     */
    public function shouldFixIssue273()
    {
        $this->populateUuid();
